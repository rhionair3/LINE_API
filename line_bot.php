...
require_once('./line_bot_class.php');
...
if($message['type']=='text') {
	if($pesan_datang=='1') {
		...
		$aa =   array(
						'type' => 'image',									
						'originalContentUrl' => 'YOU CAN USE COMPANY LOGO / PHOTO (IN JPG FORMAT)',
						'previewImageUrl' => 'YOU CAN USE COMPANY LOGO / PHOTO (IN JPG FORMAT)'	
